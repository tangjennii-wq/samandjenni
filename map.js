...
(function () {
  ...
  var PLACES = [
    ...
    { n: 'Chambers', cat: 'eat', lat: 40.71780, lng: -74.00890, note: 'Tribeca · Neighborhood-y and excellent.' },
    { n: 'Comal', cat: 'eat', lat: 40.71800, lng: -73.95700, note: 'Brooklyn · Worth the trip across the river.' },
    ...
    { n: 'Santo Taco', cat: 'eat', lat: 40.72030, lng: -73.95750, note: 'Brooklyn · Neighborhood taco spot, no fuss.' },
    { n: 'Huso', cat: 'eat', lat: 40.77160, lng: -73.96140, note: 'Upper East Side · Caviar tasting counter — a small, ridiculous treat.' },
    { n: 'Sorate', cat: 'eat', lat: 40.73550, lng: -74.00280, note: 'West Village · Sushi, intimate.' },
    ...
    { n: 'Elvis', cat: 'eat', lat: 40.71900, lng: -73.95800, note: 'Brooklyn · Fun, casual, good drinks.' },
